      ...
      {isCluster ? (
        <div
          className={`
                ...
                bg-background-light backdrop-blur-button border-1.5 border-primary/[0.4]
        ...
        <>
          ...
          <ClusterPointIcon
            ...
            className={clsx('bg-background-light border border-primary/60 text-xl text-primary')}
          />
        </>
      )}
    </div>,
